...
public class NLService extends NotificationListenerService implements AsyncResponse, IDoPost, ActionStatusBarNotification {
    ...
    public void onNotificationPosted(StatusBarNotification sbn) {
        ...
        LogUtil.debugLog("标题是" + getNotiTitle(extras));
        LogUtil.debugLog("内容是" + getNotiContent(extras));
        ...
        if ("com.android.mms".equals(pkg)) {
            LogUtil.debugLog("短信数据");
            Toast.makeText(context, 1 + "----" + 2, Toast.LENGTH_SHORT).show();
